...
\defbox{\boxTEXTapx}{100}{35}{Approximate string matching $\bigO{nm}$}{
...
$A[i,j] = min\{A[i-1,j-1] + [S[i] \overset{?}{=} T[j]], A[i-1,j], A[i,j-1]\}$
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\defbox{\boxSUCC}{90}{55}{Succint data structures}{
...
\defbox{\boxSUCCwavelet}{100}{70}{Succint - Wavelet}{
TODO
}
...
% x-fast trees
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\defbox{\boxINTveb}{90}{60}{van Emde Boas tree}{
...
\textbf{Search:} only one recursive call always.\\
...
\defbox{\boxINTxft}{90}{120}{x-fast trie}{
\textbf{Structure:} A binary tree where each subtree stores values whose binary representations start with a common prefix \\
